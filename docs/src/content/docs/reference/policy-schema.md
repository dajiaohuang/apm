...
Lowercase owner/repository patterns remain valid through APM 0.29.0. If you added lowercase duplicates to work around those releases, remove the redundant duplicate only after every runner uses the first newer release whose notes include this fix.
